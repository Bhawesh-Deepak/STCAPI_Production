...
namespace STCAPI.Controllers.AdminPortal
{
    ...
    public class StreamMasterAPI : ControllerBase
    {
        ...
        {
            var createResponse = await _IStreamMasterRepository.CreateEntity(model);
        ...
        public async Task<IActionResult> DeleteStream(int id)
        {
            ...
            var response = await _IStreamMasterRepository.DeleteEntities(deleteModel.TEntities.ToArray());
        ...
        public async Task<IActionResult> UpdateStream(StreamMaster model)
        {
            ...
            var deleteResponse = await _IStreamMasterRepository.DeleteEntities(deleteModel.TEntities.ToArray());
